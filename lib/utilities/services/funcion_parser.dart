...
class Parser {
  ...
  static Future<bool> existColumna({required Database db,required String baseDato,required String columnaAdd}) async {
    List<Map<String, dynamic>> columnas =
        await db.rawQuery('PRAGMA table_info($baseDato)');
    ...
    await db.execute('ALTER TABLE $baseDato ADD COLUMN $columnaAdd INTEGER');
    return false;
  }
}
