...
ThemeData light = ThemeData(
    ...
    cardTheme:
        const CardThemeData(elevation: 2, color: LightTheme.second),
    ...
    switchTheme: SwitchThemeData(
        ...
        trackColor: WidgetStateProperty.all<Color>(
            LightTheme.primary.withAlpha(50))),
    ...
    appBarTheme: AppBarTheme(
        ...
        titleTextStyle: const TextStyle(
            color: LightTheme.second, fontSize: 32, fontWeight: FontWeight.bold)),
...
ThemeData dark = ThemeData(
    ...
    dividerColor: DarkTheme.grey,
    textTheme: const TextTheme(
        bodyLarge: TextStyle(color: DarkTheme.grey),
        bodyMedium: TextStyle(color: DarkTheme.grey),
        bodySmall: TextStyle(color: DarkTheme.grey),
        displaySmall: TextStyle(color: DarkTheme.grey),
        displayMedium: TextStyle(color: DarkTheme.grey),
        displayLarge: TextStyle(color: DarkTheme.grey),
        headlineLarge: TextStyle(color: DarkTheme.grey),
        headlineMedium: TextStyle(color: DarkTheme.grey),
        headlineSmall: TextStyle(color: DarkTheme.grey),
        titleMedium: TextStyle(color: DarkTheme.grey),
        titleLarge: TextStyle(
    ...
    cardTheme:
        const CardThemeData(elevation: 2, color: DarkTheme.second),
    ...
    switchTheme: SwitchThemeData(
        ...
        trackColor: WidgetStateProperty.all<Color>(
            DarkTheme.primary.withAlpha(50))),
    radioTheme: RadioThemeData(
    ...
    appBarTheme: AppBarTheme(
        ...
        titleTextStyle: const TextStyle(
            color: DarkTheme.second, fontSize: 32, fontWeight: FontWeight.bold)),
    scrollbarTheme: const ScrollbarThemeData(
        radius: Radius.circular(24),
