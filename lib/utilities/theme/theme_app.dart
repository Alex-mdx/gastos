...
ThemeData dark = ThemeData(
    ...
    cardTheme: const CardThemeData(elevation: 2, color: DarkThemeColors.second),
    ...
    inputDecorationTheme: InputDecorationTheme(prefixIconColor: DarkThemeColors.darkGrey, suffixIconColor: DarkThemeColors.primary, fillColor: Colors.white, filled: true, iconColor: DarkThemeColors.primary, contentPadding: const EdgeInsets.only(left: 20, right: 20, top: 20, bottom: 20), floatingLabelStyle: const TextStyle(color: DarkThemeColors.primary), hintStyle: const TextStyle(fontSize: 14), enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(borderRadius), borderSide: const BorderSide(color: Colors.transparent, width: 2)), focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(borderRadius), borderSide: const BorderSide(color: Colors.transparent, width: 2)), border: OutlineInputBorder(borderRadius: BorderRadius.circular(borderRadius), borderSide: const BorderSide(color: Colors.transparent, width: 2))),
    ...
    splashColor: Colors.grey[200],
    highlightColor: Colors.grey[100],
    tooltipTheme: TooltipThemeData(textStyle: const TextStyle(color: Colors.white, fontSize: 18), decoration: BoxDecoration(color: DarkThemeColors.primary, borderRadius: BorderRadius.circular(borderRadius))),
